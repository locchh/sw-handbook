...
1. **Match the scope.** A one-off script doesn't need SOLID; a shared library does.
1. **Rule of three.** Don't abstract a duplication until you have three instances — two can be coincidence.
1. **Refactor opportunistically.** Apply principles when you're already touching the code, not as a standalone cleanup pass.
