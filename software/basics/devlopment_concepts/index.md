...
1. **Identify Bottlenecks**: Monitor performance and identify constraints
1. **Extract Database**: Move to split DB when database becomes bottleneck
1. **Service Extraction**: Extract high-load or independent features as services
1. **Full Decomposition**: Move to full microservices when team and complexity justify it
...
1. **Observation Tools**:
1. CPU: `top`, `htop`, `mpstat`
1. Memory: `free`, `vmstat`
1. I/O: `iostat`, `iotop`
1. Network: `netstat`, `iftop`
1. Comprehensive: `dstat`, `glances`
1. **Profiling Techniques**:
1. Sampling profilers: Capture stack traces at intervals
1. Tracing profilers: Instrument code to track execution
1. Distributed tracing: Track requests across services (Jaeger, Zipkin)
1. Flame graphs: Visualize CPU/memory usage hierarchically
1. **Performance Testing**:
1. Load testing: Simulate expected load (JMeter, Locust)
1. Stress testing: Find breaking points
1. Soak testing: Verify stability under sustained load
1. Spike testing: Test response to sudden load increases
