...
For the mechanics on specific platforms — which file to add, how GitLab / GitHub / Azure Pipelines / Jenkins / Vercel connect to your repo, where secrets live, and what CPU and memory a job gets — see [CI/CD Platforms](https://locchh.github.io/sw-handbook/software/tool_tip/cicd/index.md).
