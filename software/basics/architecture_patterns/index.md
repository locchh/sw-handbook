...
1. Small teams: Monolithic or Client-Server
1. Large teams: Microservices or SOA
1. **System Complexity**
1. Simple: Monolithic
1. Complex: Microservices or Event-Driven
1. **Scalability Requirements**
1. Low: Monolithic
1. High: Microservices, Event-Driven, or Serverless
1. **Performance Requirements**
1. Low latency: Monolithic
1. High throughput: Event-Driven or Microservices
1. **Budget Constraints**
1. Limited: Monolithic or Serverless
1. High: Microservices or SOA
