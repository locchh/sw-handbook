...
- **Measure before micro-optimizing.** Profile, don't guess — see [Architecture § Performance Bottlenecks](https://locchh.github.io/sw-handbook/software/basics/architecture/index.md).
