...
Turning data into answers. Where the [DIKW pyramid](introduction_to_data.md) explained *why* data becomes insight, this page is the *how* — the questions you ask and the statistics behind them.
...
2. **Missing values** — how many, and why.
3. **Distributions** — histograms; is it skewed, bimodal, normal?
4. **Outliers** — errors or real extremes?
5. **Relationships** — how do variables move together?
...
- **Start with the question.** Most data projects fail from a fuzzy goal, not a bad model (see [Introduction to Data](introduction_to_data.md)).
