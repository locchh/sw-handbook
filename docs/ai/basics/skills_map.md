...
**In this handbook:** [AI Concepts](concepts.md) covers the building blocks; [The LLM Landscape](landscape.md) covers the layers you assemble them from, including the observability and evaluation tools this loop depends on. For delivery, [CI/CD Platforms](../../software/tool_tip/cicd.md) covers pipeline mechanics, while [Running a Server](../../software/tool_tip/server_operations.md) covers capacity and operations when you self-host.
...
**In this handbook:** [Becoming Senior](../../software/basics/becoming_senior.md) covers thinking in business capabilities rather than frameworks; [Lifecycle](../../software/basics/lifecycle.md) covers the delivery process; [CI/CD Platforms](../../software/tool_tip/cicd.md) covers the concrete automation machinery.
