...
Agents that live in your terminal and edit your repository. See [AI Tools](../tool_tip/tools.md) and [Spec-Driven Development](../tool_tip/spec_driven_development.md) for the workflows built on top of them.
