...
Modern web auth usually means a token (a [JWT](abbreviations.md)) or session issued after login, often via **OAuth 2.0 / OIDC** for delegated access:
