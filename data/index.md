...
- **Fundamentals** - Overview of data, data types, and the DIKW pyramid.
- **Data Modelling & Architecture** - Conceptual/logical/physical models, dimensional design, and blueprints.
...
- **Data Quality & Cleansing** - Quality dimensions and the profiling-to-monitoring workflow.
- **Data Governance & Management** - Ownership, stewardship, catalogs, and DAMA-DMBOK.
- **Data Classification & Security** - Sensitivity tiers, controls, and compliance frameworks.
